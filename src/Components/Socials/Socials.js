...
const githubClick = () => {
window.open('https://github.com/miadodgson')
}

const socialLink2Click = () => {
window.open('http://linkedin.com/in/maria-dodgson-a74462201')}

const socialLink3Click = () => {
...
<div className={styles.card} style={{backgroundColor:'transparent'}}>
  <a className={styles.socialLink} onClick={githubClick}>
  <svg className={styles.github} xmlns="http://www.w3.org/2000/svg" fill="#fff" height="1em" viewBox="0 0 496 512">
  ...
  <a className={styles.socialLink2} onClick={socialLink2Click}>
  ...
  <a class={styles.socialLink3} onClick={socialLink3Click}>
